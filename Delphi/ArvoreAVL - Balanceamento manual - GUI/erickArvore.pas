...
// Extra: Balanceamento dinâmico acionado por gatilho, sem limites de No's a ser balanceado
// Extra: Representação Grafica da estrutura da arvore acionada por gatilho
// Extra: Tratamento anticolisão para No's em representação grafica  
// Data: 15/11/2010
